...
export default {
  ...
  methods: {
    submit () {
      ...
      formData.append('contest_route[picture]', this.file)
      const url = `${this.baseUrl}/gyms/${this.contest.gym.id}/contests/${this.contest.id}/contest_routes/${this.contestRoute.id}/add_picture.json`

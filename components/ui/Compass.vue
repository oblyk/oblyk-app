      ...
      >
        <g transform="translate(-103.36682,-110.34313)">
          <g transform="matrix(0.30985702,0,0,0.30985702,71.337882,76.152539)">
            <path
              style="stroke:none;"
              :style="`fill:${orientations.includes('north') ? '#e53935' : 'rgba(0,0,0,0.25)'}`"
            ...
            <path
              style="stroke:none;"
              :style="`fill:${orientations.includes('east') ? '#e53935' : 'rgba(0,0,0,0.25)'}`"
            ...
            <path
              style="stroke:none;"
              :style="`fill:${orientations.includes('south') ? '#e53935' : 'rgba(0,0,0,0.25)'}`"
            ...
            <path
              style="stroke:none;"
              :style="`fill:${orientations.includes('west') ? '#e53935' : 'rgba(0,0,0,0.25)'}`"
            ...
            <path
              style="stroke:none;"
              :style="`fill:${orientations.includes('north_east') ? '#e53935' : 'rgba(0,0,0,0.25)'}`"
              d="m 122.6649,111.52151 -7.04971,4.21905 0.56487,2.26579 2.26672,0.5658 z"
            />
            <path
              style="stroke:none;"
              :style="`fill:${orientations.includes('north_west') ? '#e53935' : 'rgba(0,0,0,0.25)'}`"
              d="m 104.54486,111.52151 7.04971,4.21905 -0.56487,2.26579 -2.26672,0.5658 z"
            />
            <path
              style="stroke:none;"
              :style="`fill:${orientations.includes('south_west') ? '#e53935' : 'rgba(0,0,0,0.25)'}`"
              d="m 104.54486,129.64155 7.04971,-4.21905 -0.56487,-2.26579 -2.26672,-0.5658 z"
            />
            <path
              style="stroke:none;"
              :style="`fill:${orientations.includes('south_east') ? '#e53935' : 'rgba(0,0,0,0.25)'}`"

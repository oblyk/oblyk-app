    ...
    <div class="svg-season-container">
      ...
      >
        <g transform="translate(-41.175977,-37.359951)">
          <path
            :class="seasons.includes('summer') ? 'active-winter' : 'inactive-season'"
          ...
          />
          <path
            :class="seasons.includes('autumn') ? 'active-summer' : 'inactive-season'"
          ...
          />
          <path
            :class="seasons.includes('winter') ? 'active-autumn' : 'inactive-season'"

export default {
  ...
  actions: {
    ...
    upload: 'Upload',
    reverse: 'Reverse',
    dismountRoute: 'Archive route',
    dismountAllRoutes: 'Archive all routes',
  ...
  common: {
    ...
    areYouSurDismountedRoute: 'Are you sure you want to archive the route(s) ?',
    ...
    pages: {
      ...
      supportUs: {
        title: 'Support us',
        noLimite: 'In Oblyk there are no limits, no premium account, no adds, no sponsored link. Everything is free! ;)',
        ...
        extraEuro: "If you have a few bucks to spent, you like the work done and want to encourage Oblyk development, we encourage you to make a donation ;)<br>It is for us a priceless help! You will help us continue the development and ensure it's future ;)",
  ...
  components: {
    ...
    guideBookPaper: {
      ...
      figures: {
        ...
        routes: 'routes',
        missingBook: 'One guidebook might interest you :) | %{count} guidebooks might interest you :)',
        seeGuides: 'See guidebooks',
    ...
    gymAdmin: {
      ...
      routes: 'Routes',
      dismountedRoutes: 'Archived routes',
      mountedRoutes: 'Current routes',
      dismountRoutes: 'Archive %{count} line | Archive %{count} lines',
      mountRoutes: 'Add %{count} line | Add %{count} lines',
    ...
    gymRoute: {
      ...
      sorts: {
        ...
        level: 'Sort by level',
        point: 'Sort by point',
        opened_at_dismounted: 'Archived routes'
      }
    },
    gymGrade: {
    ...
    user: {
      ...
      privateLogBook: 'The %{name}\'s logbook is private.',

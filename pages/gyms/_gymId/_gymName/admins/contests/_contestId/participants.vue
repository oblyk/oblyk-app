        ...
        <v-card>
          ...
          <div class="px-4 pb-4">
            <v-alert
              ...
              text
            >
              Si vous utilisez la <strong>page présentation</strong> : avant de lancer le tirage au sort utilisez le boutons <strong>"Ouvrir la tombola"</strong>
              pour afficher le tirage au sort en temps réel à vos participant(e)s.<br>
            ...
            <div v-if="tombolaShowWinner">
              ...
              <v-sheet class="back-app-color pa-2 text-h4 rounded text-center">

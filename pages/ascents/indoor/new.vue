<template>
  <div>
    <page-header
      :title="$t('components.ascentCragRoute.addedAscentToLogbook')"
      back-to="/indoor"
    />
    <v-container>
...
import AscentGymBulkForm from '~/components/ascentGymRoutes/forms/AscentGymBulkForm'
...
export default {
  components: { PageHeader, MyFollowedGyms, AscentGymBulkForm, GymSmallCard, GymSearchForm },

...
| {{ $t('components.markdown.explain.left') }}    |   {{ $t('components.markdown.explain.center') }}   |    {{ $t('components.markdown.explain.right') }} |
      ...
      <table class="table-full-width">
        <thead>
          <tr>
            <th class="text-left">{{ $t('components.markdown.explain.this') }}</th>
            <th class="text-center">{{ $t('components.markdown.explain.is') }}</th>
            <th class="text-right">{{ $t('components.markdown.explain.complicated') }}</th>
          </tr>
        </thead>
        <tbody>
          <tr>
            <td>{{ $t('components.markdown.explain.column') }}</td>
            <td class="text-center">{{ $t('components.markdown.explain.column') }}</td>
            <td class="text-right">{{ $t('components.markdown.explain.column') }}</td>
          </tr>
          <tr>
            <td>{{ $t('components.markdown.explain.alignedTo') }}</td>
            <td class="text-center">{{ $t('components.markdown.explain.alignedIn') }}</td>
            <td class="text-right">{{ $t('components.markdown.explain.alignedTo') }}</td>
          </tr>
          <tr>
            <td>{{ $t('components.markdown.explain.left') }}</td>
            <td class="text-center">{{ $t('components.markdown.explain.center') }}</td>
            <td class="text-right">{{ $t('components.markdown.explain.right') }}</td>
          </tr>
        </tbody>
      </table>
    </v-alert>
